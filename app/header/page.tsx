                ...
                <nav className="flex items-center justify-between rounded-xl border border-white/10 bg-slate-950/80 px-4 py-3 shadow-lg backdrop-blur-md">
                    <div className="flex items-center gap-3">
                        <Link href="#home" className="flex items-center gap-2">
                            ...
                            <span className="font-semibold text-cyan-300 text-sm sm:text-base">Full Stack Dev</span>
                        </Link>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        <a
                            ...
                            rel="noreferrer"
                            aria-label="GitHub"
                            className="inline-flex items-center gap-2 rounded-md border border-cyan-400/20 bg-cyan-400/10 px-3 py-2 text-cyan-300 transition hover:bg-cyan-400/20"
                        >
                        ...
                        <a
                            href="#contact"
                            className="inline-flex items-center justify-center rounded-md bg-cyan-400 px-3 py-2 font-semibold text-slate-950 transition hover:scale-105"
