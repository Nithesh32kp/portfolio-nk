                ...
                <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] items-center">
                    <div className="space-y-6">
                        ...
                        <p className="max-w-2xl text-slate-300 text-sm md:text-base">
                            ...
                            blending creativity with technical expertise to craft seamless
                            digital experiences.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <a
                                href="#contact"
                                className="inline-flex items-center justify-center rounded-full border border-cyan-400/20 px-6 py-3 text-sm font-semibold text-cyan-300 transition hover:border-cyan-300"
                            >
                                Booking
                            </a>
                        </div>
